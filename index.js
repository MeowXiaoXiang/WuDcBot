...
//bot.sendMessage({to: channelID,message: ''});
        switch(cmd) {
			...
			case '阿6':
			case '啊6':
			if (channelID == 627471208291762176) {bot.sendMessage({to: channelID,message: '<@&614789432247320576> <@467218596855152670>' + '可憐的<@' + userID + '>想找人打R6' + '\r\n組隊缺人～揪滿開團！'});}
			else {{bot.sendMessage({to: channelID,message: '@everyone 組隊缺人～揪滿開團！'});}}
			var ranr6 = Math.floor(Math.random()*30)+1;
